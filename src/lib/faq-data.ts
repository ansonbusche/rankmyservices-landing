export const FAQS = [
  ...
  },
  {
    ...
    a: "SEO gets a page ranked in a list of links. GEO gets your business named inside the answer itself — often before anyone sees a list of links at all. The two overlap, and strong SEO helps GEO.",
  },
  {
